...
<head>
  ...
  <title>Pricing | Dash UI - Bootstrap 5 Admin Dashboard Template</title>
</head>
...
<body>
  <main id="main-wrapper" class="main-wrapper">
    ...
    @@include('../partials/navbar-vertical.html', { "page": "pricing", "page_group": "layoutPage", })
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled mt-4 mb-0">
                        ...
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">12+</span> Adv. Components
                        </li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">5</span> - Landing page</li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">3</span> Dashboard Layouts</li>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body p-6 border-bottom mb-4">
                      <div class="d-flex align-items-center mb-3">
                        ...
                        <!-- text -->
                        <div class="ms-2">
                          <span class="badge badge-warning-soft">Most Popular</span>
                        </div>
                      </div>
                      <!-- text -->
                    ...
                    <div class="card-body">
                      ...
                      <!-- list -->
                      <ul class="list-unstyled mt-4 mb-0">
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i>Basic + 30+ New Components
                        </li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">12+</span> Adv. Components
                        </li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">5</span> - Landing page</li>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-12 mb-3">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <!-- list -->
                      <ul class="list-unstyled mt-4 mb-0">
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i>All Bootstrap 5 Components
                        </li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">12+</span> Adv. Components
                        </li>
                        <li class="mb-1"><i data-feather="check-circle" class="me-2 text-success icon-xs"></i><span class=" text-dark">5</span> - Landing page</li>
